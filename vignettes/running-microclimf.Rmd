...
* [Model inputs](#model-inputs)  
  + [Meterological data](#meterological-data)
  + [Vegetation paramaters](#vegetation-paramaters)
  + [Soil paramaters](#soil-paramaters)
 
* [Ground heat flux](#Ground-heat-flux)
  + [Overview](#ground-overview)
  + [Soil moisture](#soil-moisture)
  + [Soil temperature](#lsoil-temperature)
...
### Soil parameters
The inbuilt dataset `soilc` gives an example of the vegetation parameters needed to run the model. Here the attributes are shown and plotted:
...
## Deriving additional model paramters
...
Here again, the red lines are values from `NicheMapR` and the black lines those from the simple model. As can be seen, the simple soil model approximates soil surface temperature relatively well, though the extremes are not always that well-captured.
